...
La tabla 5 revela una estructura formativa predominantemente básica en la región Pacífica colombiana, teniendo el nivel de secundaria con la mayor proporción con un total de 3,306 casos (79.3%), esta concentración implica que la gran mayoría de la población cuenta con educación básica completa, pero presenta una brecha significativa en formación avanzada. Le siguen en importancia la formación técnica o tecnológica con 398 casos (9.5%) y la educación universitaria con 262 observaciones (6.3%). La educación primaria representa apenas el 3.6% (149 casos), mientras que los estudios de postgrado constituyen el segmento más reducido con solo 54 casos (1.3%). Esta distribución evidencia una pirámide educativa marcadamente amplia en la base y muy estrecha en la cúspide, patrón que sugiere limitaciones en el acceso a educación superior y especializada en la región.
...
La tabla 6 revela una marcada disparidad de género. Los datos muestran una predominancia significativa de hombres como jefes de hogar, representando el 64.6% del total (2,694 casos), mientras que las mujeres constituyen el 35.4% (1,475 casos). Lo que significa que los hombres superan en casi el doble en proporción a las mujeres como jefe de hogar, que puede asociarse a factores culturales, económicos y sociales característicos de la región Pacífica
...
Además, la jefatura masculina está sobrerrepresentada, ya que tiene 64.6% hombres frente al 35.4% mujeres, lo cual condiciona la cantidad absoluta de observaciones por categoría y, por ende, la visibilidad de colas y outliers en cada caja.
